...
public class JSONAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        //How long does your ListView need to be?
        return mJsonArray.length();
    }

    @Override
    public Object getItem(int position) {
        //returns the book for a given position, counting up from 0. A single book is represented
        // by a JSONObject
    ...
    public long getItemId(int position) {
        ...
        //If you needed to go back and query for more information based on a certain item’s ID number,
        // this method would be helpful for you.
        return position;
    }
